...
public class Similarities {
    ...
    public static nn.sim.VectorSimilarity vectorCosine(FastPreferenceData<?, ?> preferences, boolean dense) {
        return new nn.sim.VectorSimilarity(preferences, dense) {
            @Override
    ...
    public static nn.sim.VectorSimilarity vectorJaccard(FastPreferenceData<?, ?> preferences, boolean dense) {
