...
/**
 * Created by messe on 11/06/18.
 */
public class SpotifyPreferenceReader implements PreferencesReader {

    public static <U, I> SpotifyPreferenceReader get() {
        return new SpotifyPreferenceReader();
    }
